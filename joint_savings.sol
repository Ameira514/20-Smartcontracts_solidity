    ...
    */
    function withdraw(uint amount, address payable recipient) public {
        ...
        */
        ...
        /*
        Add and `if` statement to check if 
        the `lastToWithdraw` is not equal to (`!=`) to `recipient` 
        ...
        */
        ...
        // Call the `transfer` function of the `recipient` and pass it 
        // the `amount` to transfer as an argument.
    ...
    function deposit() public payable {
        ...
        /*
        Call the `contractBalance` variable and set it 
        equal to the balance of the contract by using `address(this).balance`.
        */
        contractBalance = address(this).balance;
    }

    /*
    Define a `public` function named `setAccounts` that receive 
    two `address payable` arguments named `account1` and `account2`.
    */
    function setAccounts(address payable account1, address payable account2) public{

        // Set the values of `accountOne` and `accountTwo` to `account1` and 
        // `account2` respectively.
        accountOne = account1;
        accountTwo = account2;
    }
